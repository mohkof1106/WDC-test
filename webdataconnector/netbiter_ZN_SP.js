(function() {
    ...
    myConnector.getSchema = function(schemaCallback) {
        ...
        var cols = [{
            ...
            alias: " Rev. 2 - Total active energy (kWh)",
            dataType: tableau.dataTypeEnum.float
        },
		
		{
            id: "Rev1Totalactiveenergyconsumption",
            alias: " Rev. 1 - Daily Total active energy consumption(kWh)",
            dataType: tableau.dataTypeEnum.float
        },{
            id: "Rev2Totalactiveenergyconsumption",
            alias: " Rev. 2 - Daily Total active energy consumption (kWh)",
            dataType: tableau.dataTypeEnum.float
        },
		
		{
            id: "SolarMeter1TotalActivePower",
			alias: "Solar Meter 1 Total Active Power (kW)",
            dataType: tableau.dataTypeEnum.float
        }, {
            id: "SolarMeter1Totalactiveenergy",
            alias: " Solar Meter 1 Total active energy (kWh)",
            dataType: tableau.dataTypeEnum.float
        },
        ...
        var tableSchema = {
            id: "ZN_SPDeviceUniqueID",
            alias: "ZN_SOUTH Device Unique ID",
            columns: cols
        };
	...
	//console.log('data_col '+JSON.stringify(tableDa))	
		...
		id_=["61523.0.120559","61523.0.120565","61591.8800.158687","61591.8800.158696","63104.9040.166464","74126.9817.183748","74126.9817.183753"];
		var sys_id={}
		var sys_id={"61523.0.120559":"Rev1Totalactivepower","61523.0.120565":"Rev1Totalactiveenergy","61591.8800.158687":"Rev2Totalactivepower","61591.8800.158696":"Rev2Totalactiveenergy","63104.9040.166464":"ZN_SP_Tank_level","74126.9817.183748":"SolarMeter1TotalActivePower","74126.9817.183753":"SolarMeter1Totalactiveenergy"};
	...
	for (var zj = 0, zlentj = consta; zj < zlentj; zj=zj+1) {
			...
			for (var tj = 0, tlentj = filteredData.length; tj < tlentj; tj++) {
				if (filteredData[tj].ZN_SP_Tank_level >0){
				filt.push( filteredData[tj].ZN_SP_Tank_level );
				filt_time[filteredData[tj].ZN_SP_Tank_level]=filteredData[tj].timestamp
				
				

				}
				
				if (filteredData[tj].Rev1Totalactiveenergy >0){
				filt_kwh1.push( filteredData[tj].Rev1Totalactiveenergy );
				filt_kwh1_time[filteredData[tj].Rev1Totalactiveenergy]=filteredData[tj].timestamp
				
				

				}
				
				if (filteredData[tj].Rev2Totalactiveenergy >0){
				filt_kwh2.push( filteredData[tj].Rev2Totalactiveenergy );
				filt_kwh2_time[filteredData[tj].Rev2Totalactiveenergy]=filteredData[tj].timestamp
    ...
    $(document).ready(function() {
        $("#submitButton").click(function() {
            tableau.connectionName = "ZN_SOUTH Field Data"; // This will be the data source name in Tableau
