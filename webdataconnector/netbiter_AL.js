(function() {
    ...
    myConnector.getSchema = function(schemaCallback) {
        ...
        var cols = [{
            ...
            alias: " Rev. 1 - Total Active Energy (kWh)",
            dataType: tableau.dataTypeEnum.float
        },{
            ...
            id: "Rev3Totalactivepower",
			alias: "Rev. 3 - Total Active Power (kW)",
            dataType: tableau.dataTypeEnum.float
        }, {
            id: "Rev3Totalactiveenergy",
            alias: " Rev. 3 - Total Active Energy (kWh)",
            dataType: tableau.dataTypeEnum.float
        },{
            id: "AL_Tank_level",
            alias: "AL Tank Level (l)",
            dataType: tableau.dataTypeEnum.float
        },{
            id: "Solar_Meter_1_Total_Active_Power",
        ...
        var tableSchema = {
            id: "ALDeviceUniqueID",
            alias: "AM_LANDMARK Device Unique ID",
            columns: cols
        };
	...
	//console.log('data_col '+JSON.stringify(tableDa))	
		...
		id_=["73530.9812.183612","73530.9812.183621","73531.9813.183650","73531.9813.183641","73532.9814.183679","73532.9814.183670","73593.9825.183941","76181.9526.177129","76181.9526.177132"];
		var sys_id={}
		var sys_id={"73530.9812.183612":"Rev1Totalactivepower","73530.9812.183621":"Rev1Totalactiveenergy","73531.9813.183641":"Rev2Totalactivepower","73531.9813.183650":"Rev2Totalactiveenergy","73532.9814.183670":"Rev3Totalactivepower","73532.9814.183679":"Rev3Totalactiveenergy","73593.9825.183941":	"AL_Tank_level","76181.9526.177129"	:"Solar_Meter_1_Total_Active_Power","76181.9526.177132":"SolarMeter1Totalactiveenergy"};
	...
	for (var zj = 0, zlentj = consta; zj < zlentj; zj=zj+1) {
			...
			for (var tj = 0, tlentj = filteredData.length; tj < tlentj; tj++) {
				if (filteredData[tj].AL_Tank_level >0){
				filt.push( filteredData[tj].AL_Tank_level );
				filt_time[filteredData[tj].AL_Tank_level]=filteredData[tj].timestamp			
    ...
    $(document).ready(function() {
        $("#submitButton").click(function() {
            tableau.connectionName = "AM_LANDMARK Field Data"; // This will be the data source name in Tableau
