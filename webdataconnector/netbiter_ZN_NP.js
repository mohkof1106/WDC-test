(function() {
    ...
    myConnector.getSchema = function(schemaCallback) {
        ...
        var tableSchema = {
            id: "ZN_NPDeviceUniqueID",
            alias: "ZN_NORTH  Device Unique ID",
            columns: cols
        };
	...
	//console.log('data_col '+JSON.stringify(tableDa))	
		...
		id_=["61519.0.120504","61519.0.120507","61522.0.120516","61522.0.120523","62468.0.122054"];
		var sys_id={}
		var sys_id={"61519.0.120504":"Rev1Totalactivepower","61519.0.120507":"Rev1Totalactiveenergy","61522.0.120516":"Rev2Totalactivepower","61522.0.120523":"Rev2Totalactiveenergy","62468.0.122054":	"ZN_NP_Tank_level"};
	...
	for (var zj = 0, zlentj = consta; zj < zlentj; zj=zj+1) {
			...
			for (var tj = 0, tlentj = filteredData.length; tj < tlentj; tj++) {
				if (filteredData[tj].ZN_NP_Tank_level >0){
				filt.push( filteredData[tj].ZN_NP_Tank_level );
				filt_time[filteredData[tj].ZN_NP_Tank_level]=filteredData[tj].timestamp
    ...
    $(document).ready(function() {
        $("#submitButton").click(function() {
            tableau.connectionName = "ZN_NORTH Field Data"; // This will be the data source name in Tableau
